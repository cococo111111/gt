...
<div class="col-lg-12">
    <div class="ibox product-detail">
        <div class="ibox-content">
            <div class="row">
                <h2>
                    <i class="fa fa-database"></i> Update synonym
                </h2>
                <form action="${pageContext.request.contextPath}/updateSynonym" method="post" id="form-Synonym"
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <a class="btn btn-primary waves-effect col-mb-3 fa fa-history" style="font-size:18px"
                                   href="${pageContext.request.contextPath}/viewSynonym?txtKeyOriginalId=${txtKeyOriginalId}&txtKeyOriginalName=${txtKeyOriginalName}">
                                    Back
                                </a>
