...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>${promotion.name} - ${promotion.details}
            <c:if test="${promotion.discountRate>0}">
                ${promotion.discountRate}%
            </c:if></h2>
        <jsp:useBean id="dateObject" class="java.util.Date"/>
        <jsp:setProperty name="dateObject" property="time" value="${promotion.startDate}"/>
        <b><fmt:formatDate value="${dateObject}" pattern="dd/MM/yyyy"/></b> -
        <jsp:setProperty name="dateObject" property="time" value="${promotion.endDate}"/>
        <b><fmt:formatDate value="${dateObject}" pattern="dd/MM/yyyy"/></b>
        <div class="m-t-10 m-b-10 m-l-15">
            <a class="btn btn-primary waves-effect col-mb-3 fa fa-history"
               style="font-size:18px" href="${pageContext.request.contextPath}/viewPromotion">
                Back
            </a>
        </div>
    </div>
    ...
    <div class="col-xs-12 m-t-5">
        <div class=" col-xs-6  col-sm-6">
            ...
            <form action="${pageContext.request.contextPath}/addItemsIntoPromotion" method="POST">
                <select id="select_item" name="listAddProduct" data-placeholder="Choose a product..."
                        class="chosen-select text-center" multiple
                        style="width:90%;"
                        tabindex="4">
                    <c:forEach var="listProduct" items="${listNotAdd}">
                ...
                <div class="m-b-10">
                    ...
                    <input type="hidden" name="txtPromotionId" value="${promotion.id}"/>
