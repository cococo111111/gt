...
<div class="col-lg-12">
    <div class="ibox product-detail">
        <div class="ibox-content">
            <div class="row">
                <h2>
                    <i class="fa fa-database"></i> Update floor
                </h2>
                <p>
                </p>
                <form action="${pageContext.request.contextPath}/updateFloor" method="post" id="form-floor"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-8">
                            <input type="text" id="codeproduct" required="required"
                                   ...
                                   name="txtName" value="${txtName}" maxlength="20">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <a class="btn btn-primary waves-effect col-mb-3 fa fa-history" style="font-size:18px"
                                   href="${pageContext.request.contextPath}/viewFloor">
                                    Back
                                </a>
