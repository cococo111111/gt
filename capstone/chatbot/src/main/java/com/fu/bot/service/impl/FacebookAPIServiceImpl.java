...
public class FacebookAPIServiceImpl implements FacebookAPIService {
    ...
    public void createGreetingText() {
        ...
        String greeting = "{text: \"Bắt đầu nào!\"}";
...
//        buttonList.add(helper.createLawTodayMenu());
//        buttonList.add(helper.createSmartTrafficMenu());
        buttonList.add(helper.createFeedBackMenu());
