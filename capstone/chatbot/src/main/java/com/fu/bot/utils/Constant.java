...
public class Constant {
    ...
    public static final String DO_NOT_UNDERSTAND_MESSAGE = "\u0042\u1ea1\u006e \u0063\u00f3 \u0074\u0068\u1ec3 \u0068\u1ecf\u0069 \u0042\u006f\u0074 \u0074\u0068\u0065\u006f \u006d\u1eab\u0075 \u0063\u00e2\u0075 \u0076\u00ed \u0064\u1ee5 \u006e\u0068\u01b0\u003a \u0074\u00f4\u0069 \u006d\u0075\u1ed1\u006e \u006d\u0075\u0061 \u006d\u00ec \u0067\u00f3\u0069\u002e";


    public enum SHORT_KEY {
        TYPE("@"), SHOW_CART("@gh"), RESET("@xoa"), HISTORY("@ls"), PROMOTION("@km"), FEEDBACK("@ph");
    ...
    public static final String INTENT_SEARCH_FAULT = "searchFault";

    public static final String INTENT_SEARCH_TRACFFICJAM= "searchTrafficJam";

    public static final String INTENT_SEARCH_GAS= "searchGas";

    public static final String INTENT_NORMAL_SPEECH= "normalSpeech";

    public static final String INTENT_ENCOURAGE_SPEECH= "encourageSpeech";

    public static final String INTENT_SEARCH_FAULT_COMBINE= "searchFaultCombine";

    public static final String HELLO_MESSAGE = "\u0058\u0069\u006e \u0063\u0068\u00e0\u006f";

    public static final String WELCOME_MESSAGE ="em là Emily";
    public static final String ASK_PHONE_MESSAGE = "";
    public static final String INSTALL_APP_MESSAGE ="";
    ...
    public static final String PHONE_ALREADY_REGISTERED_BY_THAT_USER = "\u0042\u1ea1\u006e \u0111\u00e3 \u0111\u0103\u006e\u0067 \u006b\u00fd \u0073\u1ed1 \u0111\u0069\u1ec7\u006e \u0074\u0068\u006f\u1ea1\u0069 \u006e\u00e0\u0079 \u0076\u1edb\u0069 \u0063\u0068\u00fa\u006e\u0067 \u0074\u00f4\u0069 \u003a\u0044";
    ...
    public enum BUTTON_TYPE {
        ...
        ANSWER_NO("answerNo"),ANSWER_YES("answerYes");
    ...
    public enum MENU_TYPE {
        ...
        LAWTODAY("lawtoday"),SMARTTRAFFIC("smarttraffic");
    ...
    public static final String TYPE_ANSWER = "showAnswer";

    public static final String NEARBY_PRODUCT = "\u0053\u1ea3\u006e \u0070\u0068\u1ea9\u006d \u1edf \u0067\u1ea7\u006e \u0062\u1ea1\u006e\u003a";

    public static final String SHORT_KEY_NOT_FOUND = "\u0050\u0068\u00ed\u006d \u0074\u1eaf\u0074 \u006b\u0068\u00f4\u006e\u0067 \u0074\u1ed3\u006e \u0074\u1ea1\u0069\u002e\n\u0044\u0061\u006e\u0068 \u0073\u00e1\u0063\u0068 \u0070\u0068\u00ed\u006d \u0074\u1eaf\u0074\u003a\n\u0040\u0067\u0068 \u002d \u0078\u0065\u006d \u0067\u0069\u1ecf \u0068\u00e0\u006e\u0067\n\u0040\u0078\u006f\u0061 \u002d \u0074\u1ea1\u006f \u006d\u1edb\u0069 \u0067\u0069\u1ecf \u0068\u00e0\u006e\u0067\n\u0040\u006c\u0073 \u002d \u006c\u1ecb\u0063\u0068 \u0073\u1eed \u006d\u0075\u0061 \u0068\u00e0\u006e\u0067\n\u0040\u006b\u006d \u002d \u006b\u0068\u0075\u0079\u1ebf\u006e \u006d\u00e3\u0069 \u0068\u00f4\u006d \u006e\u0061\u0079\n\u0040\u0070\u0068 \u002d \u0070\u0068\u1ea3\u006e \u0068\u1ed3\u0069 \u006b\u1ebf\u0074 \u0071\u0075\u1ea3";
    ...
    public enum BASIC_BUTTON {
        ...
        NEXT_SHOW("\u0058\u0065\u006d \u0074\u0068\u00ea\u006d"),
        BACK_SHOW("\u0051\u0075\u0061\u0079 \u006c\u1ea1\u0069"),
        SUGGEST("\u0053\u1ea3\u006e \u0070\u0068\u1ea9\u006d \u006c\u0069\u00ea\u006e \u0071\u0075\u0061\u006e"),
        //Giao thông hôm nay
        SHOW_CART("\u0047\u0069\u0061\u006f \u0074\u0068\u00f4\u006e\u0067 \u0068\u00f4\u006d \u006e\u0061\u0079"),
        //Giá xăng hôm nay
        RESET_CART("\u0047\u0069\u00e1 \u0078\u0103\u006e\u0067"),
        //Mẹo tham gia giao thông
        PROMOTION("\u004d\u1eb9\u006f \u0074\u0068\u0061\u006d \u0067\u0069\u0061 \u0067\u0069\u0061\u006f \u0074\u0068\u00f4\u006e\u0067"),
        HISTORY("\u004c\u1ecb\u0063\u0068 \u0073\u1eed \u006d\u0075\u0061 \u0068\u00e0\u006e\u0067"),
        FEEDBACK("\u0050\u0068\u1ea3\u006e \u0068\u1ed3\u0069 \u006b\u1ebf\u0074 \u0071\u0075\u1ea3"),
        ANSWER_YES("\u0043\u00f3"),
        ANSWER_NO("\u004b\u0068\u00f4\u006e\u0067"),
        LAWTODAY("Luật mỗi ngày"),
        SMARTTRAFFIC("Mẹo đi đường");
